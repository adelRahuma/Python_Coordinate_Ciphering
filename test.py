...
def process_1(args):
    df, random_numbers, random_nums = args
...
if __name__ == '__main__':
    args_1 = (num_polygons, random_numbers, random_nums)
    args_2 = (num_polygons, random_nums)
    with ThreadPool(processes=2) as pool:
        result_1 = pool.apply(process_1, args=(args_1,))
        result_2 = pool.apply(process_2, args=(args_2,))
